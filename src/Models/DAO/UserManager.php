...
class UserManager{
    /**
     * Stockage  dans cet attibut d'une instance de PDO de connexion active à la BDD
     */
    private PDO $db;
    ...
    /**
     * On se sert du constructeur pour hydrater l'attribut $db avec une instance de connexion à la BDD
     * (récupérée via la fonction connectedDb() )
     */
    ...
    /**
     * Méthode permettant de récupérer un User trouvé dans la BDD par rapport à la valeur d'un champ
