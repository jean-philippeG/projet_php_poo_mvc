...
<html lang="fr">
<head>
    <title>Mon Profil - projet_php_poo_mvc</title>
...
<div class="container">
    ...
    <div class="row my-5">
        <div class="col-12">
            <h1 class=text-center>Mon profil - Wikifruit</h1>
        </div>
    </div>
        ...
        <div class="col-12 col-lg-6 mx-auto">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <!-- Pas besoin du HTMLSPECIALCHARS car il s'agit d'un objet "DateTime" qui ne peut être qu'une date valide -->
